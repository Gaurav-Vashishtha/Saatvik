              ...
              <div class="col-md-6 mb-3">
               ...
               <div class="col-md-6 mb-3">
                ...
                <select name="salutation" class="form-select">
                    ...
                    <option value="Mr" <?= ($employee->salutation=='Mr')?'selected':''; ?>>Mr</option>
                    <option value="Ms" <?= ($employee->salutation=='Ms')?'selected':''; ?>>Ms</option>
                    <option value="Mrs" <?= ($employee->salutation=='Mrs')?'selected':''; ?>>Mrs</option>
                    <option value="Dr" <?= ($employee->salutation=='Dr')?'selected':''; ?>>Dr</option>
                </select>
               </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="full_name"
                           class="form-control"
                           value="<?= set_value('full_name',$employee->full_name); ?>"
                           required>
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date"
                           name="date_of_birth"
                           class="form-control"
                           value="<?= set_value('date_of_birth',$employee->date_of_birth); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date"
                           ...
                           class="form-control"
                           value="<?= set_value('date_of_joining',$employee->date_of_joining); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number"
                           name="age"
                           class="form-control"
                           value="<?= set_value('age',$employee->age); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3" id="anniversary_section">
                    ...
                    <input type="date"
                           ...
                           class="form-control"
                           value="<?= set_value('anniversary_date',$employee->anniversary_date); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="designation"
                           class="form-control"
                           value="<?= set_value('designation',$employee->designation); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="department"
                           class="form-control"
                           value="<?= set_value('department',$employee->department); ?>">
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text"
                           name="location_name"
                           class="form-control"
                           value="<?= set_value('location_name',$employee->location_name); ?>">
                </div>

                <div class="col-md-12 mb-3">
                    <label class="form-label">Remark</label>
                    <textarea name="remark" class="form-control"><?= set_value('remark',$employee->remark); ?></textarea>
                </div>
