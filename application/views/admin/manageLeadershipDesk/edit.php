<div class="card shadow-sm">
    ...
    <div class="card-header">
        <h5 class="mb-0">Edit Leadership Desk Content</h5>
    </div>
        ...
        <form method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text"
                       class="form-control"
                       value="<?php 
                            if($item->section=='corporate') echo 'Corporate Communication';
                            elseif($item->section=='notice') echo 'Notice & Circulars';
                            elseif($item->section=='joinee') echo 'New Joinee Welcome';
                       ?>"
                       readonly>
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="<?= site_url('admin/manage-leadership-desk?section='.$item->section); ?>"
