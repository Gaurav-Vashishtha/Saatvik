            ...
            <tbody>
                ...
                <?php if (!empty($items)): $i = 1; foreach ($items as $row): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($row->status == 1): ?>
                                <a href="<?= base_url('admin/manage-leadership-desk/toggle/'.$row->id); ?>"
                        ...
                        <td>
                            <a href="<?= base_url('admin/manage-leadership-desk/edit/'.$row->id); ?>"
                               class="btn btn-sm btn-warning">
                               <i class="fa fa-edit"></i>
                            </a>

                            <a href="<?= base_url('admin/manage-leadership-desk/delete/'.$row->id); ?>"
